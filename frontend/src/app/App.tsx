...
import { KnowledgeStatsPage } from '@pages/knowledge/KnowledgeStatsPage';
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route element={<AuthGuard><Layout /></AuthGuard>}>
              ...
              />
              <Route
                path="/projects/:projectId/knowledge/statistics"
                element={<ProjectAdminRoute><ErrorBoundary><KnowledgeStatsPage /></ErrorBoundary></ProjectAdminRoute>}
              />
              <Route
