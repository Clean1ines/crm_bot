...
describe('selectClaimClustersView', () => {
  ...
  it('links retry and completed compaction attempts to a single batch by batch or group scope', () => {
    const view = selectClaimClustersView(
      workflow({
        claim_clusters: [
          {
  ...
  it('does not attach a group-scoped compaction attempt to every batch in a multi-batch cluster', () => {
        ...
        claim_clusters: [
          {
            ...
            batches: [
              ...
              },
              {
                ...
                source_node_refs: ['node-3'],
                raw_claim_refs: ['claim-2'],
                compacted_node_refs: [],
              },
            ],
            members: [],
    ...
    expect(view.compaction.attempts).toHaveLength(1);
    expect(view.compaction.attempts[0]).toMatchObject({
      key: 'attempt-work-2',
      workItemId: 'work-2',
      batchRef: 'batch-2',
