  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 p-4">
      <div className="ml-auto h-full max-w-3xl overflow-auto rounded-2xl bg-[var(--surface-elevated)] p-5 shadow-xl">
        <div className="flex items-center justify-between"><h2 className="text-lg font-semibold text-[var(--text-primary)]">{t('ragEval.curation.diagnostics.title')}</h2><button type="button" onClick={onClose} className="text-sm text-[var(--text-muted)]">{t('common.actions.close')}</button></div>
