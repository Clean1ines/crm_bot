...
export const KNOWLEDGE_PREPROCESSING_MODE_OPTIONS: KnowledgePreprocessingModeOption[] = [
  {
    ...
    description: 'Компилирует документ в проверяемые смысловые ответы для вопросов клиентов, условий и FAQ.',
  },
  {
    value: 'price_list',
    label: 'Прайс / каталог',
    description: 'Компилирует цены, услуги, тарифы и каталоги в ответы, привязанные к источнику.',
  },
  {
    value: 'instruction',
    label: 'Инструкции / правила',
    description: 'Компилирует регламенты, политики и процедуры в ясные ответы с опорой на документ.',
  },
  {
    value: 'plain',
    label: 'Legacy / без смысловой компиляции',
    description: 'Служебный режим: сохраняет документ без KCD-компиляции смысловых ответов. Для production-базы обычно не подходит.',
  },
];
