...
class ProjectTokenPort(Protocol):
    ...
    async def get_client_telegram_bot_id(self, project_id: str) -> int | None: ...

    async def get_manager_telegram_bot_id(self, project_id: str) -> int | None: ...
...
class ProjectControlPort(ProjectReadPort, Protocol):
    ...
    async def set_client_telegram_bot_id(
        self, project_id: str, telegram_bot_id: int | None
    ) -> None: ...
