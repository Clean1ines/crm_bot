# ruff: noqa: F401,F811
# Internal extracted Stage K helper surface generated from the pre-facade split implementation.
# Do not import this module from queue handlers or from KnowledgeIngestionService facade.
