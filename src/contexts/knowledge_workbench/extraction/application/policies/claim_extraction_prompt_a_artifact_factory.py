...
PROMPT_A_RAW_CLAIM_OBSERVATIONS_ARTIFACT_KIND = ArtifactKind(
...
class ClaimExtractionPromptAArtifacts:
    raw_output_artifact: PipelineArtifact
    parsed_output_artifact: PipelineArtifact


class ClaimExtractionPromptAArtifactFactory:
    """Build Workbench-owned Prompt A artifacts from the actual LLM outcome.

    Artifact Runtime stays generic. This factory owns the claim-extraction
    payload contract and the raw -> parsed lineage relation.
    """
    ...
    def build(
        ...
        *,
        ...
        created_at: datetime,
        updated_at: datetime,
    ) -> ClaimExtractionPromptAArtifacts:
        ...
        raw_artifact = PipelineArtifact(
            ...
            artifact_kind=PROMPT_A_RAW_CLAIM_OBSERVATIONS_ARTIFACT_KIND,
        ...
        parsed_artifact = PipelineArtifact(
            ...
            artifact_kind=PROMPT_A_PARSED_CLAIM_OBSERVATIONS_ARTIFACT_KIND,
            payload=ArtifactPayload(
        ...
        return ClaimExtractionPromptAArtifacts(
