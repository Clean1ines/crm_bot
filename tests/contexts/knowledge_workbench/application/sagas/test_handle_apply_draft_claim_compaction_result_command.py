...
class FakeOutbox:
    ...
    events_by_id: dict[WorkflowEventId, WorkflowEvent] = field(default_factory=dict)
...
@pytest.mark.asyncio
async def test_existing_next_work_item_appends_reconcile_without_prepare_assumption() -> None:
    workflow_uow = FakeWorkflowUnitOfWork()
