...
class _FakeRepo:
    ...
    async def add_source_chunks(
        self, *, project_id: str, document_id: str, chunks
    ...
    async def save_surface_source_units(
        self, *, run_id: str, document_id: str, source_units
    ) -> None:  # noqa: ANN001, ARG002
        if source_units:
            self.calls.surface_source_units += len(source_units)

    async def update_surface_compiler_run_status(
        self, *, run_id: str, status: str, error_type=None, error_message=None
    ) -> None:  # noqa: ANN001, ARG002
        return
    ...
    async def update_document_status(
        self, document_id: str, status: str, detail: str | None = None
    ) -> None:  # noqa: ARG002
