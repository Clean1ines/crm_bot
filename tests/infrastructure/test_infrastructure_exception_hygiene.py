...
from src.infrastructure.db.repositories.user_repository import _hash_password, _verify_password
...
def test_verify_password_returns_false_for_malformed_hash():
    ...
    assert _verify_password("secret", "pbkdf2_sha256$210000$not-base64$also-not-base64") is False
