...
def _project_config_view(
    ...
    return ProjectConfigurationView(
        ...
        integrations=[
            item
            if isinstance(item, ProjectIntegrationView)
            else ProjectIntegrationView.from_record(item)
            for item in (integrations or [])
        ],
        channels=[
            item
            if isinstance(item, ProjectChannelView)
            else ProjectChannelView.from_record(item)
...
class TestProjectsAPI:
    ...
    def test_list_projects_success(self, client):
        ...
        try:
            ...
            mock_repo.get_projects_for_user_view = AsyncMock(
                return_value=[
                    ProjectSummaryView(
                        id=str(uuid4()),
                        name="Proj1",
    ...
    def test_create_project_success(self, client):
        ...
        try:
            ...
            mock_repo.create_project_with_user_id.assert_awaited_once_with(
                user_id, "New Project"
            )
    ...
    def test_get_project_forbidden(self, client):
        ...
        try:
            mock_repo = AsyncMock(spec=ProjectRepository)
            mock_repo.get_project_view = AsyncMock(
                return_value=_project_view(project_id, other_user_id, name="Test")
            )
        ...
        try:
            ...
            mock_repo.get_project_view = AsyncMock(
                side_effect=[
                    ...
                    _project_view(
                        project_id, user_id, name="Updated", is_pro_mode=False
                    ),
                ]
            )
    ...
    def test_update_project_forbidden(self, client):
        ...
        try:
            ...
            mock_repo.project_exists = AsyncMock(return_value=True)
            mock_repo.get_project_view = AsyncMock(
                return_value=_project_view(project_id, other_user_id)
            )
    ...
    def test_set_bot_token_success(self, client):
        ...
        try:
            ...
            response = client.post(
                f"/api/projects/{project_id}/bot-token", json=payload
            )
            assert response.status_code == 200
    ...
    def test_set_bot_token_not_found(self, client):
        ...
        try:
            ...
            response = client.post(
                f"/api/projects/{project_id}/bot-token", json={"token": "t"}
            )
            assert response.status_code == 404
            assert response.json()["detail"] == "Project not found"
    ...
    def test_set_manager_token_success(self, client):
        ...
        try:
            ...
            response = client.post(
                f"/api/projects/{project_id}/manager-token", json=payload
            )
            assert response.status_code == 200
            assert response.json() == {"status": "ok"}

            mock_repo.set_manager_bot_token.assert_awaited_once_with(
                project_id, "man123:token"
            )
            mock_repo.upsert_project_channel.assert_awaited_once_with(
                project_id,
                kind="manager",
    ...
    def test_set_manager_token_not_found(self, client):
        ...
        try:
            ...
            response = client.post(
                f"/api/projects/{project_id}/manager-token", json={"token": "t"}
            )
            assert response.status_code == 404
            assert response.json()["detail"] == "Project not found"
    ...
    def test_set_manager_token_rejects_empty_token(self, client):
        ...
        try:
            ...
            response = client.post(
                f"/api/projects/{project_id}/manager-token", json={"token": "   "}
            )
    ...
    def test_get_managers_success(self, client):
        ...
        try:
            ...
            mock_repo.get_manager_notification_targets = AsyncMock(
            ...
            mock_repo.get_manager_notification_targets.assert_awaited_once_with(
                project_id
            )
    ...
    def test_add_manager_success(self, client):
        ...
        try:
            ...
            mock_repo.add_manager_by_telegram_identity = AsyncMock(
                return_value={
                    "status": "added",
            ...
            mock_repo.add_manager_by_telegram_identity.assert_awaited_once_with(
                project_id, "777"
            )
    ...
    def test_add_manager_forbidden_no_project(self, client):
        ...
        try:
            ...
            response = client.post(
                f"/api/projects/{project_id}/managers", json={"chat_id": 123}
            )
            assert response.status_code == 403
            assert response.json()["detail"] == "Access denied"
    ...
    def test_remove_manager_success(self, client):
        ...
        try:
            ...
            mock_repo.remove_manager_by_telegram_identity.assert_awaited_once_with(
                project_id, "888"
            )
    ...
    def test_connect_bot_client_success(self, client):
        ...
        try:
            ...
            response = client.post(
                f"/api/projects/{project_id}/connect-bot", json=payload
            )
            assert response.status_code == 200
            assert response.json() == {"status": "ok", "type": "client"}
    ...
    def test_list_project_members_success(self, client):
        ...
        try:
            ...
            mock_repo.get_project_members_view = AsyncMock(
                return_value=[
    ...
    def test_upsert_project_member_success(self, client):
        ...
        try:
            ...
            mock_repo.add_project_member.assert_awaited_once_with(
                project_id, member_user_id, "manager"
            )
    ...
    def test_delete_project_member_success(self, client):
        ...
        try:
            ...
            assert response.status_code == 204
            mock_repo.remove_project_member.assert_awaited_once_with(
    ...
    def test_get_project_configuration_view_success(self, client):
        ...
        try:
            ...
            mock_repo.get_project_configuration_view = AsyncMock(
                return_value=_project_config_view(
                    project_id,
    ...
    def test_update_project_settings_success(self, client):
        ...
        try:
            ...
            response = client.patch(
                f"/api/projects/{project_id}/settings", json={"brand_name": "Acme"}
            )
            assert response.status_code == 200
            assert response.json()["settings"]["brand_name"] == "Acme"
            mock_repo.update_project_settings.assert_awaited_once_with(
                project_id, {"brand_name": "Acme"}
            )
    ...
    def test_update_project_policies_success(self, client):
        ...
        try:
            ...
            assert response.status_code == 200
            assert (
                response.json()["policies"]["routing_policy_json"]["mode"] == "support"
            )
    ...
    def test_update_project_limits_success(self, client):
        ...
        try:
            ...
            response = client.patch(
                f"/api/projects/{project_id}/limits", json={"requests_per_minute": 30}
            )
            assert response.status_code == 200
    ...
    def test_list_project_integrations_success(self, client):
        ...
        try:
            ...
            assert response.status_code == 200
            assert response.json() == [
                {"provider": "custom_webhook", "status": "enabled"}
            ]
    ...
    def test_upsert_project_integration_success(self, client):
        ...
        try:
            ...
            mock_repo.upsert_project_integration = AsyncMock(
                return_value=ProjectIntegrationView(
                    id=str(uuid4()),
                    project_id=project_id,
    ...
    def test_upsert_project_channel_success(self, client):
        ...
        try:
            ...
            mock_repo.upsert_project_channel = AsyncMock(
                return_value=ProjectChannelView(
                    id=str(uuid4()),
                    project_id=project_id,
                    kind="widget",
                    provider="web",
    ...
    def test_project_configuration_openapi_contract_is_typed(self):
        ...
        assert paths["/api/projects/{project_id}/configuration"]["get"]["responses"][
            "200"
        ]["content"]["application/json"]["schema"]["$ref"].endswith(
            "/ProjectConfigurationResponse"
        )
        assert paths["/api/projects/{project_id}/settings"]["patch"]["responses"][
            "200"
        ]["content"]["application/json"]["schema"]["$ref"].endswith(
            "/ProjectConfigurationResponse"
        )
        assert paths["/api/projects/{project_id}/policies"]["patch"]["responses"][
            "200"
        ]["content"]["application/json"]["schema"]["$ref"].endswith(
            "/ProjectConfigurationResponse"
        )
        assert paths["/api/projects/{project_id}/limits"]["patch"]["responses"]["200"][
            "content"
        ]["application/json"]["schema"]["$ref"].endswith(
            "/ProjectConfigurationResponse"
        )

        integrations_schema = paths["/api/projects/{project_id}/integrations"]["get"][
            "responses"
        ]["200"]["content"]["application/json"]["schema"]
        assert integrations_schema["items"]["$ref"].endswith(
            "/ProjectIntegrationResponse"
        )
        assert paths["/api/projects/{project_id}/integrations"]["post"]["responses"][
            "201"
        ]["content"]["application/json"]["schema"]["$ref"].endswith(
            "/ProjectIntegrationResponse"
        )

        channels_schema = paths["/api/projects/{project_id}/channels"]["get"][
            "responses"
        ]["200"]["content"]["application/json"]["schema"]
        assert channels_schema["items"]["$ref"].endswith("/ProjectChannelResponse")
        assert paths["/api/projects/{project_id}/channels"]["post"]["responses"]["201"][
            "content"
        ]["application/json"]["schema"]["$ref"].endswith("/ProjectChannelResponse")
